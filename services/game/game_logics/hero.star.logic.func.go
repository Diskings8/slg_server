...
const heroMaxStarStage int32 = 5 // 星级上限

var (
	ErrHeroStarFull      = errors.New("hero already max star stage")
	ErrHeroNoConsumeCard = errors.New("no same config hero card to consume")
)
