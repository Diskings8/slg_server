...
type GameService_StreamClient interface {
	Send(*GameServiceNodePacketReq) error
	Recv() (*GameServiceNodePacketRsp, error)
	grpc.ClientStream
}
...
func (x *gameServiceStreamClient) Send(m *GameServiceNodePacketReq) error {
	return x.ClientStream.SendMsg(m)
}

func (x *gameServiceStreamClient) Recv() (*GameServiceNodePacketRsp, error) {
	m := new(GameServiceNodePacketRsp)
...
type GameService_StreamServer interface {
	Send(*GameServiceNodePacketRsp) error
	Recv() (*GameServiceNodePacketReq, error)
	grpc.ServerStream
}
...
func (x *gameServiceStreamServer) Send(m *GameServiceNodePacketRsp) error {
	return x.ServerStream.SendMsg(m)
}

func (x *gameServiceStreamServer) Recv() (*GameServiceNodePacketReq, error) {
	m := new(GameServiceNodePacketReq)
