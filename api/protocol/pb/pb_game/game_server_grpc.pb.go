...
type GameServiceClient interface {
	Stream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[GameServiceNodePacketReq, GameServiceNodePacketRsp], error)
}
...
func (c *gameServiceClient) Stream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[GameServiceNodePacketReq, GameServiceNodePacketRsp], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GameService_ServiceDesc.Streams[0], GameService_Stream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GameServiceNodePacketReq, GameServiceNodePacketRsp]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GameService_StreamClient = grpc.BidiStreamingClient[GameServiceNodePacketReq, GameServiceNodePacketRsp]

// GameServiceServer is the server API for GameService service.
// All implementations must embed UnimplementedGameServiceServer
// for forward compatibility.
type GameServiceServer interface {
	Stream(grpc.BidiStreamingServer[GameServiceNodePacketReq, GameServiceNodePacketRsp]) error
...
func (UnimplementedGameServiceServer) Stream(grpc.BidiStreamingServer[GameServiceNodePacketReq, GameServiceNodePacketRsp]) error {
...
func _GameService_Stream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GameServiceServer).Stream(&grpc.GenericServerStream[GameServiceNodePacketReq, GameServiceNodePacketRsp]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GameService_StreamServer = grpc.BidiStreamingServer[GameServiceNodePacketReq, GameServiceNodePacketRsp]
...
func (c *gameHandlerClient) CreateRole(ctx context.Context, in *pb_common.CreateRoleReq, opts ...grpc.CallOption) (*pb_common.CreateRoleRsp, error) {
	...
	err := c.cc.Invoke(ctx, GameHandler_CreateRole_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameHandlerClient) LoginOnce(ctx context.Context, in *pb_common.LoginOnceReq, opts ...grpc.CallOption) (*pb_common.LoginOnceRsp, error) {
	...
	err := c.cc.Invoke(ctx, GameHandler_LoginOnce_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedGameHandlerServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func RegisterGameHandlerServer(s grpc.ServiceRegistrar, srv GameHandlerServer) {
	// If the following call pancis, it indicates UnimplementedGameHandlerServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
